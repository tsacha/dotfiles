; Generated by kalamine on 2025-02-13
...
;  Letters, third row
 ...
 SC2c::SendKey("U+0078", {"**": "U+00df", "*¨": "U+1e8d", "*˙": "U+1e8b", "*µ": "U+03be"}) ; x
+SC2c::SendKey("U+0058", {"**": "U+1e9e", "*¨": "U+1e8c", "*˙": "U+1e8a", "*µ": "U+039e"}) ; X

 SC2d::SendKey("U+002d", {"**": "U+2011", "*^": "U+207b", "*ˇ": "U+208b"}) ; -
+SC2d::SendKey("U+003f", {"**": "U+00bf"}) ; ?

 SC2e::SendKey("U+0076", {"**": "U+2013", "*~": "U+1e7d"}) ; v
+SC2e::SendKey("U+0056", {"*~": "U+1e7c"}) ; V
...
+SC2b::SendKey("U+007c", {}) ; |
 ...
 SC56::SendKey("U+007a", {"**": "U+00e6", "*´": "U+017a", "*^": "U+1e91", "*ˇ": "U+017e", "*/": "U+01b6", "*˙": "U+017c", "*µ": "U+03b6"}) ; z
+SC56::SendKey("U+005a", {"**": "U+00c6", "*´": "U+0179", "*^": "U+1e90", "*ˇ": "U+017d", "*/": "U+01b5", "*˙": "U+017b", "*µ": "U+0396"}) ; Z
